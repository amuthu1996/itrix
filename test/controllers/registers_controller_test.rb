...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { college: @register.college, email: @register.email, itrix_id: @register.itrix_id, mobile: @register.mobile, name: @register.name, year: @register.year }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { college: @register.college, email: @register.email, itrix_id: @register.itrix_id, mobile: @register.mobile, name: @register.name, year: @register.year }
    assert_redirected_to register_path(assigns(:register))
  end
